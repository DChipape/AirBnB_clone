...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    """Unittests for the testing of prompting of Airbnb command interpreter."""
...
class TestHBNBCommand_exit(unittest.TestCase):
    ...
    """Unittests for the testing of exiting from the interpreter."""
